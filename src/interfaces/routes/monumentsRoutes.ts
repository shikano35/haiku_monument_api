...
const convertMonumentToResponse = (monument: Monument): MonumentDetail => {
  try {
    ...
    return {
      ...
      is_reliable: monument.isReliable ?? true,
      verification_status: monument.verificationStatus ?? "unverified",
      verified_at: monument.verifiedAt,
      verified_by: monument.verifiedBy,
      reliability_note: monument.reliabilityNote,
    ...
    return {
      ...
      is_reliable: monument.isReliable ?? true,
      verification_status: monument.verificationStatus ?? "unverified",
      verified_at: monument.verifiedAt ?? null,
      verified_by: monument.verifiedBy ?? null,
      reliability_note: monument.reliabilityNote ?? null,
      created_at: monument.createdAt,
      updated_at: monument.updatedAt,
      inscriptions: [],
      events: [],
